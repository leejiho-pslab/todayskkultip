...
const baseSite = {
  ...
  categories: [
    ...
    // 도메인(starship-ent.ai.kr) 유입 트래픽 활용 — 콘서트 티켓팅·오디션·팬라이프 실용정보
    { slug: "ent", name: "연예·팬라이프", desc: "콘서트 티켓팅, 오디션 지원, 팬클럽·굿즈 등 팬 실용정보" },
  ],

  // 사칭·혼동 방지 고지 (도메인명이 유사한 기업과의 비제휴 명시 — 푸터 노출)
  disclaimerExtra:
    "본 사이트는 독립 생활정보 매체로, 스타쉽엔터테인먼트(Starship Entertainment) 등 특정 기업·기획사와 무관하며 어떠한 제휴 관계도 없습니다.",
  ...
  authorProfile: {
    ...
    jobTitle: "생활정보 에디터",
    bio: "생활정보·공공요금·지원금 분야를 다루는 편집팀입니다. 모든 글은 정부24·국세청·지자체 등 공식 자료를 직접 확인해 작성하고, 제도·요금·신청 기준이 바뀌면 기준 시점과 출처를 함께 표기해 갱신합니다. 독자가 실제 신청·절약에 바로 쓸 수 있는 구체적 방법과 사례 중심으로 정리합니다.",
