...
4. 12개 중 6~7개는 "실생활·시즌 밀착형"으로: 제철음식/제철 식재료, 보양식·열 내리는 음식,
   휴가·명절 필수템, 냉방·난방용품, 절기별 집안 관리 등 — 지금 계절에 검색량이 치솟는 생활 주제
   (3번 구매가이드형과 겹쳐도 좋음: 예 "가을 보양식 재료 싸게 사는 법").
5. 카테고리 5종에 고르게 분배하되, season·life 비중을 높여도 됨
6. 아래 기존 주제와 겹치거나 유사한 것 금지:
- ${exclusion}
